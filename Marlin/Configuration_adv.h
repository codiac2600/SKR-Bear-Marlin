...
#define PRUSA_SKR_CONFIGURATION_VERSION 20210719
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_3_CONFIRM
    ...
    #define MAIN_MENU_ITEM_8_DESC "UBL Mesh Wizard"
    #define MAIN_MENU_ITEM_8_GCODE "M1004"
    #define MAIN_MENU_ITEM_8_CONFIRM

    #define MAIN_MENU_ITEM_9_DESC "Adjust Point Near"
    #define MAIN_MENU_ITEM_9_GCODE "G29 P4\nM500"
    #define MAIN_MENU_ITEM_9_CONFIRM
  #endif

  #define MAIN_MENU_ITEM_10_DESC "Firmware Updater" // Reboot controller to prepare for firmware update via SD card.
...
//#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M117 Sheet Loaded"
